...
2026-09-16 更新：原图观感优先。允许 720 个分层碎片及预绘局部柔光，不再把减少数量、取消柔光或压暗主体当作目标。当前实现与证据见 [最新逐图报告](22-lighting-final-review.md)，下列逐图标准继续有效。
...
- 初次补参考时未修改渲染；后续同一 PR 的材质重做已同步 PRD，业务规则与成长档案格式保持不变。
