...
<p id="reason" style="color:#ffcf9b"></p><p><small>实时深度画面（不是彩色录像）· 白框是检测范围</small></p><canvas id="view" width="960" height="500"></canvas><p><small>圆点表示持续检测到的近墙区域，不代表已确认手掌或真实接触。编号仅用于短时跟踪。</small></p><p id="saved"></p>
<script>
